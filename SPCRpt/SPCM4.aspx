<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SPCM4.aspx.cs" Inherits="SPCRpt.SPCM4" %>
                    ...
                    <tr width="100%">
                        <td width="100%">
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                                SelectMethod="GetData" TypeName="SPCRpt.dtSPCTableAdapters.SP_SPC_ReportsTableAdapter">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="lblFrom" Name="Date" PropertyName="Text" Type="String" />
                                    <asp:ControlParameter ControlID="lblShift" Name="Shift" PropertyName="Text" Type="String" />
                                    <asp:ControlParameter ControlID="lblMachineId" Name="MachineId" PropertyName="Text"
                                        Type="String" />
                                </SelectParameters>
                            </asp:ObjectDataSource>
                            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}"
                                SelectMethod="GetData" TypeName="SPCRpt.dtSPCTableAdapters.SP_SPC_Reports_ThicknessTableAdapter">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="lblFrom" Name="Date" PropertyName="Text" Type="String" />
                                    <asp:ControlParameter ControlID="lblShift" Name="Shift" PropertyName="Text" Type="String" />
                                    <asp:ControlParameter ControlID="lblMachineId" Name="MachineId" PropertyName="Text"
